    ...
    set_soft_tips:function(rdata,type){
        ...
        if(type == 10){
            ...
            if((ltd > 0 && (ltd == pro || pro < 0)) || (ltd < 0 && pro >= 0) || (ltd > 0 && pro >= 0)){
                ...
                _ltd = 2;
                explain.html('VŨ THÁI hay còn có nick name mới là Z_OV bản tool này đã được cài đặt hạn dử dụng'+(type == 12?'&nbsp;&nbsp;<span style="color:#af8e48">Sau khi nâng cấp Phiên bản Doanh nghiệp, doanh nghiệp có thể dùng thử miễn phí trình cắm Phiên bản Doanh nghiệp và Trình cắm Phiên bản Chuyên nghiệp.</span>':''));
                if(type == 12){
